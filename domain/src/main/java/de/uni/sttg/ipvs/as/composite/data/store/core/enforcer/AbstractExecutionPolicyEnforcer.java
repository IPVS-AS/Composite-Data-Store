 ...
 * @author Roman Bitz
 */
public abstract class AbstractExecutionPolicyEnforcer extends ManagementEnforcer {
   ...
   */
  AbstractExecutionPolicyEnforcer() {
    this("", "");
  }
   ...
   */
  private AbstractExecutionPolicyEnforcer(String modelPath, String policyFile) {
   ...
   */
  private AbstractExecutionPolicyEnforcer(String modelPath, Adapter adapter) {
   ...
   * @param adapter the adapter.
   */
  private AbstractExecutionPolicyEnforcer(Model m, Adapter adapter) {
   ...
   * @param m the model.
   */
  public AbstractExecutionPolicyEnforcer(Model m) {
    this(m, null);
  }
   ...
   * @param modelPath the path of the model file.
   */
  public AbstractExecutionPolicyEnforcer(String modelPath) {
    this(modelPath, "");
  }
   ...
   */
  AbstractExecutionPolicyEnforcer(String modelPath, String policyFile, boolean enableLog) {
    this(modelPath, new FileAdapter(policyFile));
    enableLog(enableLog);
  }
